...
import { createTask, getAllTasksByProject, getTask, updateTask, deleteTask, getTaskByUser, getTasksWithAssignments, getTaskByUserByProject } from "../controllers/task_controller.js";
...
router.get("/projects/:projectId/tasks/user", authenticate, getTaskByUserByProject);
