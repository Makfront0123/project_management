...
import { createComment, getCommentsByTask, getComment, deleteComment } from "../controllers/comment_controller.js";
...
router.get("/task/:taskId/comment", authenticate, isTeamMember, getCommentsByTask);
