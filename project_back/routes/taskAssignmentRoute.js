...
import { assignUserToTask, removeUserFromTask, getAllUsersAssignedToTask, getUserAssignedToTask } from "../controllers/task_assignment_controller.js";
...
router.post("/tasks/:taskId/assignments", authenticate, isTeamAdmin, isTeamMember, assignUserToTask);
